...
function createWorld(){
	...
	//Floor
	var floor =  new THREE.Mesh(new THREE.PlaneGeometry( 200, 200, 20, 20), new THREE.MeshPhongMaterial( { color: 0x808080 , side: THREE.DoubleSide} ));
	...
	var AK47 = new THREE.ObjectLoader();
	AK47.load("objects/AK47/ak-47-kalashnikov.json", function ( obj2 ) {
		obj2.position.set(10,3,0);
	scene.add( obj2 );
	} );
